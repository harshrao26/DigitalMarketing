...
const StartAProject = () => {
  ...
  return (
    ...
    >
      {showCircle && (
        <div
          style={{
            ...
            alignItems: "center",
            pointerEvents: "none", // Ensure the circle does not interfere with pointer events
            fontSize: "18px",
            fontWeight: "bold",
            zIndex: 10,
            transform: `translate(${circlePosition.x - 50}px, ${
              circlePosition.y - 50
      ...
      <div>
        <button className="text-6xl font-semibold max-w-xl leading-tight transition-all duration-500 mb-4 hover:scale-105 hover:text-[#ffd74b]">
          Start A Project
        </button>
